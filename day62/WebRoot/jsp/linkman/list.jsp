...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/linkman/linkmanServlet?method=listLinkMan"
		method=post>
											...
											<TBODY>
												...
												<c:forEach items="${linkmans }" var="linkman">
													<TR
														...
														<TD><a
															href="${pageContext.request.contextPath }/linkman/LinkManServlet?method=editLinkManUI&lkmId=${linkman.lkmId}">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/linkman/LinkManServlet?method=deleteLinkMan&lkmId=${linkman.lkmId}">删除</a>
														</TD>
													</TR>
												</c:forEach>
											</TBODY>
