...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/customer/CustomerServlet?method=listCustomer"
		method=post>
...
TEXT-DECORATION: none">
														...
														<TD><a
															href="${pageContext.request.contextPath }/customer/CustomerServlet?method=editCusto
merUI&custId=<s:property value='#cust.custId'/>">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/customer/CustomerServlet?method=removeCus
tomer&custId=<s:property value='#cust.custId'/>">删除</a>
														</TD>
													</TR>
												</s:iterator> --%>
